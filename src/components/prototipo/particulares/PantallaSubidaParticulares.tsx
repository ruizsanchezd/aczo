...
/**
 * PantallaSubidaParticulares — paso 1 del flujo de particulares
 * (/particulares): "Sube tu factura". Calco de `PantallaSubidaEmpresas.tsx`
 * (mismo dropzone, misma subida simulada, mismo patrón de nombre/email en la
 * misma pantalla), con la única diferencia real: la copia habla de una
 * vivienda, no de varias sociedades — "una vivienda, tus facturas de luz y
 * gas", como dice la tarjeta de la landing que lleva aquí.
 *
 * Las animaciones son las mismas que en `PantallaSubidaEmpresas.tsx` — ver
 * ese fichero para el detalle (dropzone reactivo, subida a saltos, salida al
 * quitar un archivo, botón que se activa con transición de color).
 */

const AYUDA =
  "Sube todas tus facturas de luz, gas o ambas. Puedes arrastrar una foto, un PDF o un ZIP. Cuantas más facturas de un mismo CUPS, más preciso será el cálculo de tu ahorro.";
...
export function PantallaSubidaParticulares({
  onContinuar,
}: {
                ...
                >
                  ...
                  <span className="flex flex-col items-center gap-02">
                    ...
                    <Text variant="body-m" color="low" as="span">
                      Una foto, un PDF o ZIP con tus facturas de luz y gas
                    </Text>
                  </span>
                </button>
              </div>
