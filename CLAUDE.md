...
- **`/area-cliente`** — "Mi cartera": lo que ve quien YA es cliente, no el alta. Barra lateral de
  ...
  tipo de inmueble — las mismas siete categorías generales que ofrece el filtro, más un grupo
  "Sin catalogar" para los que nadie ha clasificado) y los filtros recortan la cartera antes de agruparla, así que lista, mapa, leyenda y
