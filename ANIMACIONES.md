...
- **Interruptor:** el color del carril y la posición de la bolita se animan juntos (`micro-states`).
  Ojo con el color de la bolita: tiene que contrastar con su carril en **los dos modos**
  (ver el comentario en `Switch.tsx`).
...
3. **Tarjetas de plan, al pasar por encima:** se elevan 2 px y cogen `shadow-md` (`micro-states`).
   Sutil a propósito: son tres tarjetas de decisión, no deben competir entre ellas.
4. **Los cuatro niveles de despliegue** (comercializadora → dirección → suministro → detalle), todos
...
5. **Ventana de comparación:** el velo aparece (350 ms) y la ventana **crece desde el 96 %**. Crecer
...
> **Aviso para producción:** la ventana modal se pinta con un portal, colgada del `<body>`. Dentro
